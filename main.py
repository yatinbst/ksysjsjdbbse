...
BOT_TOKEN = os.environ.get("BOT_TOKEN", "7504296093:AAFAWZw3rJSKDsxRQsEsHmhQoSa7G5met0k")
...
@bot.on_message(filters.command(["remauth"]))
async def remauth(bot, message):
    user_id = message.from_user.id
